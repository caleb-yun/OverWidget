...
public class OverWidgetActivity extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (profile != null) {
            ...
            views.setOnClickPendingIntent(R.id.appwidget_button, getPendingSelfIntent(context, ACTION_APPWIDGET_UPDATE));
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (SYNC_CLICKED.equals(intent.getAction())) {
            ...
            watchWidget = new ComponentName(context, OverWidgetActivity.class);

            //remoteViews.setTextViewText(R.id.appwidget_button, "TESTING");
